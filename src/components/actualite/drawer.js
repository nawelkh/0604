   ...
   <div className={classes.root}>
      ...
      <AppBar style={{backgroundColor:'#fff',height: 55, }} position="fixed" className={classes.appBar}>
        ...
        <img alt="Remy Sharp" src={process.env.PUBLIC_URL + '/images/loader.gif'}  style={{width: 40, height: 40}} ></img>
               ...
               <Hidden only={['sm','xs']}> 
                   <Tooltip disableFocusListener title="Voir Mon profil en tant que Visiteur ">

                        <Button style={{textTransform:'lowercase'}} onClick={profil}>
                           <Avatar alt="Remy Sharp" src={userData.imageUrl}
                            style={{width: 40, height: 40}} />
                            <h6 href="profil" className={classes.name}> {userData.prenom} </h6>      
                        </Button>
                  ...
                  <Tooltip disableFocusListener title="notifications">
                     ...
                     <IconButton aria-label=""  button onClick={handleClick1} aria-controls="prochainement"
                ...
                <InputBase
                  ...
                  classes={{root: classes.inputRoot,input: classes.inputInput,}}inputProps={{ 'aria-label': 'search' }}
                    />
                      ...
                      <BottomNavigationAction className={classes.navigationBtn} label="Modifier Profil" icon={<CgProfile  />} />
